...
//
//
//      File name:    LocalQMDParticipant.hh
//
...
#ifndef LocalQMDParticipant_hh
#define LocalQMDParticipant_hh
...
class LocalQMDParticipant
{
   public:
                                                // momentum      position
      LocalQMDParticipant( const G4ParticleDefinition* , G4ThreeVector , G4ThreeVector );
      ~LocalQMDParticipant();
